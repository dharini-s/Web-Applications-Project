...
<h4>Please enter movie information:</h4>
  ...
  <h4><font color="green">${addmoviemsg}</font></h4>
  <h4><font color="green">${linkstarmsg}</font></h4>
  <h4><font color="green">${linkgenremsg}</font></h4>
  <hr>
  <form action="/Fabflix/servlet/InsertMovie" method="post">
    <div class="form-group">
      <label for="usr">Movie Title:</label>
      <input type="text" name="movietitle" maxlength=50 class="form-control" id="usr">
    </div>
    <div class="form-group">
      <label for="usr">Movie Year:</label>
      <input type="text" name="movieyear" maxlength=50 class="form-control" id="usr">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="usr">Movie Genre:</label>
      <input type="text" name="moviegenre" maxlength=50 class="form-control" id="usr">
    </div>
    <div class="form-group">
      <label for="usr">Banner Url:</label>
      <input type="text" name="bannerurl" maxlength=50 class="form-control" id="usr">
    </div>
    <div class="form-group">
      <label for="usr">Trailer Url:</label>
      <input type="text" name="trailerurl" maxlength=50 class="form-control" id="usr">
    </div>
    <div class="form-group">
