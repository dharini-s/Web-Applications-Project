...
<div class="container">
	...
	<h3 align="center">Search returned the following results:</h3>
	<%
		...
		//String search = (String)request.getAttribute("searchString");
...
<TABLE ALIGN="CENTER">
	...
	<div align="center">
		<c:if test="${currentPage gt 1}">
			<a
				href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=${sortOrder}&recordsPerPage=${recordsPerPage}&page=${currentPage - 1}">
			...
			<tr>
				<c:forEach begin="1" end="${noOfPages}" var="i">
					<c:choose>
						...
						<c:otherwise>
							<td><a
								href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=${sortOrder}&recordsPerPage=${recordsPerPage}&page=${i}">${i}</a></td>
						</c:otherwise>
					</c:choose>
				</c:forEach>
			</tr>
		...
		<br> Sort By: <a
			href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=TitleAsc&recordsPerPage=${recordsPerPage}&page=${currentPage}">Title
			<img
			src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-arrow-up-b-128.png"
			class="order_arrow" width=20 />
		</a> | <a
			href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=TitleDesc&recordsPerPage=${recordsPerPage}&page=${currentPage}">Title
			<img
			src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-arrow-down-b-128.png"
			class="order_arrow" width=20 />
		</a> | <a
			href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=YearAsc&recordsPerPage=${recordsPerPage}&page=${currentPage}">Year
			<img
			src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-arrow-up-b-128.png"
			class="order_arrow" width=20 />
		</a> | <a
			href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=YearDesc&recordsPerPage=${recordsPerPage}&page=${currentPage}">Year
			<img
			src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-arrow-down-b-128.png"
			class="order_arrow" width=20 />
		</a> | <br>
		<p>
			Results Per Page: <a
				href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=TitleDesc&recordsPerPage=5&page=${currentPage}">5</a>
			<a
				href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=TitleDesc&recordsPerPage=10&page=${currentPage}">10</a>
			<a
				href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=TitleDesc&recordsPerPage=15&page=${currentPage}">15</a>
			<a
				href="/Fabflix/servlet/MainPage?search=${search}&sortOrder=TitleDesc&recordsPerPage=20&page=${currentPage}">20</a>
