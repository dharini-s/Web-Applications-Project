...
<div class="container">
  ...
  <form>
    <div class="form-group">
      ...
      <input type="text" name="firstName" maxlength=50 class="form-control" id="usr">
    </div>
    <div class="form-group">
      <label for="usr">Last Name:</label>
      <input type="text" name="lastName" maxlength=50 class="form-control" id="usr">
    </div>
    <div class="form-group">
      <label for="usr">Credit Card:</label>
      <input type="text" name="cardid" maxlength=50 class="form-control" id="usr">
    </div>
    <div class="form-group">
      <label for="usr">Expiration Date:</label>
      <input type="text" name="expiration" maxlength=50 class="form-control" id="usr">
    </div>
